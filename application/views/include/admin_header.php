    ...
    <div class="sidebar">
        ...
        <div class="user-panel text-center">
            <div class="image">
                ...
                <img src="<?php echo base_url().$users[0]['logo'] ?>" class="img-circle" alt="User Image">
                <?php }else {?>
        ...
        <ul class="sidebar-menu">
            ...
            <?php if ($this->session->userdata('user_type') == 1 || $this->session->userdata('user_type') == 2) { ?>
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("Cstore")) {
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == 'store_transfer' ? 'active':''))?>">
                            <a href="<?php echo base_url('Cstore/store_transfer') ?>"><?php echo display('store_transfer') ?></a>
                        </li>
                ...
                <?php if ($this->session->userdata('user_type') == '1') { ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("sms_configuration") || $this->uri->segment('2') == ("sms_template")) {
                        echo "active";
                    } else {
                        echo " ";
                    } ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?php echo (($this->uri->segment(2) == 'sms_configuration' ? 'active':''))?>">
                                <a href="<?php echo base_url('Csms_setting/sms_configuration') ?>"><?php echo display('sms_configuration') ?> </a>
                            </li>
                            <li class="<?php echo (($this->uri->segment(2) == 'sms_template' ? 'active':''))?>">
                                <a href="<?php echo base_url('Csms_setting/sms_template') ?>"><?php echo display('sms_template') ?> </a>
                            </li>
                        </ul>
                    </li>
...
<!--                    <li><i class="fa fa-cloud-download" aria-hidden="true"></i><span><a href="--><?php //echo base_url('autoupdate') ?><!--">--><?php //echo display('update') ?><!-- </a></span></li>-->
            ...
            <li class="<?php if ($this->uri->segment('1') == ("")) {
                ...
                <a href="<?php  echo base_url().'Cweb_setting/android_apps_view' ?>"><i class="fa fa-android" aria-hidden="true"></i>
