                                ...
                                <?php if($invoices_list) {
                                    ...
                                    foreach ($invoices_list as $invoice) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url().'Ccustomer/customerledger/'.$invoice['customer_id']; ?>">
                                                    <?php echo $invoice['customer_name']?> <i class="fa fa-user pull-right" aria-hidden="true"></i></a>
                                            ...
                                            <td>
                                                <form action="<?php echo base_url('Cinvoice/update_status/'.$invoice['invoice_id'])?>" method="post" id="validate">
                                                    ...
                                                    <input type="hidden" value="<?php echo $invoice['customer_id'] ?>" name="customer_id"/>
                                                    <input type="hidden" value="<?php echo $invoice['order'] ?>" name="order_no"/>
                                                    <input type="hidden" value="<?php echo $invoice['order_id'] ?>" name="order_id"/>
