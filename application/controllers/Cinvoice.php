    ...
    public function insert_pos_invoice()
    {
        ...
        if ($stok_report > 0) {
            ...
            if (!empty($product_details)) {
                ...
                class=\"form-control text-right available_quantity_" . $product_id . "\" value=\"0\" readonly=\"readonly\" style=\"width: 60px\"/>
					</td>
					<td width=\"\">
                    ...
                    . $product_id . "');\" onchange=\"quantity_calculate('" . $product_id . "');\" id=\"total_qntt_" . $product_id . "\" class=\"form-control text-right\" value=\"1\" min=\"1\" style=\"width:50px\"/>
					</td>
					<td width=\"\">
